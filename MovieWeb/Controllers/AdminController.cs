...
namespace MovieWeb.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Login(FormCollection collection)
        {
            ...
            {
                Admin ad = data.Admins.SingleOrDefault(n => n.AdminName == username && n.Password == password);
                if (ad != null)
                {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult EditActor(FormCollection collection, Actor actor)
        {
            var actorName = collection["ActorName"];
            var actorBirthDay = collection["ActorBirthDay"];
            if (String.IsNullOrEmpty(actorName))
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult EditCountry(FormCollection collection, Country country)
        {
            var countryName = collection["CountryName"];
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult EditGenre(FormCollection collection, Genre genre)
        {
            var genreName = collection["GenreName"];
